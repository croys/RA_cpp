...
// configuration step. It creates a namespace called `RA_cpp`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", RA_cpp::cmake::project_name, RA_cpp::cmake::project_version) };
